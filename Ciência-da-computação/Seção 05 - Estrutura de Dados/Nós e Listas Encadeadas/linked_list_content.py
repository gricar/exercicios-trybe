...
inserindo_numero_inicio.insert_first(3)
inserindo_numero_inicio.insert_first(9)
print(inserindo_numero_inicio)

inserindo_numero_final = LinkedList()
inserindo_numero_final.insert_last(3)
inserindo_numero_final.insert_last(9)
print(inserindo_numero_final) """